...
ARG SLF4J_URLS="https://repo1.maven.org/maven2/org/slf4j/jul-to-slf4j/${SLF4J_VERSION}/jul-to-slf4j-${SLF4J_VERSION}.jar https://repo1.maven.org/maven2/org/slf4j/slf4j-api/${SLF4J_VERSION}/slf4j-api-${SLF4J_VERSION}.jar"
